...
/*curves.Card.prototype.polar2 = function(step) {
	var ctx = this.canvas.getContext('2d')
	ctx.beginPath();
...
curves.Card.prototype.draw = function(name) {
	...
	if(curves.meta[name].scale){
		//this.width = this.height = 700;
	...
	if(curves.meta[name].scale){
		//this.canvas.width = this.canvas.height = this.width = this.height = 1000;
	}
