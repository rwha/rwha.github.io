...
curves.meta = {
	astroid: {
		type: "parametric",
		title: "Astroid",
		equation: "\\displaystyle x = a \\cos^3(t), y = a \\sin^3(t); a=9",
		draw: function(t) {
			var a = 9;
			var ci = Math.cos(t);
			var si = Math.sin(t);
	...
	prolateCycloid: {
		...
		equation: "x = t - 2\\sin t, y = 1 - 2\\cos t",
		draw: function(t) {
			var a = 1;
			var h = 2;
			var xi = a * t - h * Math.sin(t);
	...
	epitrochoid: {
		...
		title: "Epitrochoid",
		max: 20,
		equation: "x = (a+b) \\cos t - c \\cos((\\frac{a}{b} + 1)t), y = (a+b) \\sin t - c \\sin((\\frac{a}{b}+1)t)",
		draw: function(t) {
			var a = 4.5, b = 2, c = 3;
